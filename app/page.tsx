...
export default function Home() {
  return (
    <>
      <Head>
        <title>CartaListo | Optimiza tu CV y Carta de Presentación con IA</title>
        <meta
          name="description"
          content="Optimiza tu currículum y crea cartas personalizadas con IA en minutos. Herramientas en español para destacar en tus postulaciones."
        />
        <meta property="og:title" content="CartaListo - Currículum y Cartas con IA" />
        <meta
          property="og:description"
          content="Herramientas en español para mejorar tu CV y redactar cartas de presentación profesionales en segundos."
        />
